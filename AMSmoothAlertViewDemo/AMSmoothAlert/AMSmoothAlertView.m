...
- (UIView*) alertPopupView
{
    ...
    alertSquare.backgroundColor = [UIColor colorWithRed:0.937 green:0.937 blue:0.937 alpha:0.6];
    alertSquare.borderColor = [UIColor colorWithRed:0.937 green:0.937 blue:0.937 alpha:1];
